...
class MeshData(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.v_len = name_type_map['Uint'](self.context, 0, None)
		self.v_num = name_type_map['Uint'](self.context, 0, None)
		self.verts = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
	...
	def _get_attribute_list(cls):
		...
		yield 'v_len', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'v_num', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'verts', Array, (0, None, (None, None,), name_type_map['Ubyte']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'v_len', name_type_map['Uint'], (0, None), (False, None)
		yield 'v_num', name_type_map['Uint'], (0, None), (False, None)
		yield 'verts', Array, (0, None, (instance.v_num, instance.v_len,), name_type_map['Ubyte']), (False, None)
