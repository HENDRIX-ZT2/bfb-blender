...
class MeshData(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.size_of_tri_index = name_type_map['Byte'].from_value(2)
	...
	def _get_attribute_list(cls):
		...
		yield 'size_of_tri_index', name_type_map['Byte'], (0, None), (False, 2), (None, None)
		yield 'num_tri_indices', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'tris', Array, (0, None, (None, 3,), name_type_map['Ushort']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'size_of_tri_index', name_type_map['Byte'], (0, None), (False, 2)
		yield 'num_tri_indices', name_type_map['Uint'], (0, None), (False, None)
		yield 'tris', Array, (0, None, (int(instance.num_tri_indices / 3), 3,), name_type_map['Ushort']), (False, None)
