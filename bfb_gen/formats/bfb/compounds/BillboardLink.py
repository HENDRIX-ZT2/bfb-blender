...
class BillboardLink(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'u_1', name_type_map['Uint'], (0, None), (False, None), (None, None)
		...
		yield 'object_ids', Array, (0, None, (1,), name_type_map['Uint']), (False, None), (None, None)
		yield 'materials', Array, (128, None, (1,), name_type_map['FixedString']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'object_ids', Array, (0, None, (1,), name_type_map['Uint']), (False, None)
		yield 'materials', Array, (128, None, (1,), name_type_map['FixedString']), (False, None)
