...
class Bone(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.group = name_type_map['Ubyte'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'group', name_type_map['Ubyte'], (0, None), (False, None), (None, None)
		yield 'name', name_type_map['FixedString'], (64, None), (False, ), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'group', name_type_map['Ubyte'], (0, None), (False, None)
		yield 'name', name_type_map['FixedString'], (64, None), (False, )
