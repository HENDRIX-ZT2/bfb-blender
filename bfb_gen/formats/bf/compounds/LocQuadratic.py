...
class LocQuadratic(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.x_b = name_type_map['Short1000'](self.context, 0, None)
		self.y_b = name_type_map['Short1000'](self.context, 0, None)
		self.z_b = name_type_map['Short1000'](self.context, 0, None)
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'x_b', name_type_map['Short1000'], (0, None), (False, None), (lambda context: context.version >= 2, None)
		yield 'y_b', name_type_map['Short1000'], (0, None), (False, None), (lambda context: context.version >= 2, None)
		yield 'z_b', name_type_map['Short1000'], (0, None), (False, None), (lambda context: context.version >= 2, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		if instance.context.version <= 1:
			...
			yield 'x_b', name_type_map['Float'], (0, None), (False, None)
		...
		if instance.context.version >= 2:
			...
			yield 'x_b', name_type_map['Short1000'], (0, None), (False, None)
			yield 'y_b', name_type_map['Short1000'], (0, None), (False, None)
			yield 'z_b', name_type_map['Short1000'], (0, None), (False, None)
